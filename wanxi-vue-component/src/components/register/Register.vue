...
<script>
  import {mixinDevice} from 'wanxi-vue-fm/src/utils/mixin.js'
  import {getSmsCaptcha} from 'wanxi-vue-fm/src/api/login'
  import {getAction, postAction} from 'wanxi-vue-fm/src/api/manage'
  import {checkOnlyUser} from 'wanxi-vue-fm/src/api/api'
