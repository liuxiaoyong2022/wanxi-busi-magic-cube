...
<script>
  ...
  import {filterObj} from 'wanxi-vue-fm/src/utils/util'
  import { filterMultiDictText } from '../../../components/dict/JDictSelectUtil'
  import { httpGroupRequest } from 'wanxi-vue-fm/src/api/GroupRequest.js'
  import md5 from 'md5'
        ...
        httpGroupRequest(() => getAction(url), groupIdKey).then(res => {
          if(res.success){
            ...
            this.$error({
              ...
              content: (" Popup初始化失败，请检查你的配置或稍后重试！错误信息如下：{res.message}"),
              onOk: () => this.close(),
            })
          }
        })
